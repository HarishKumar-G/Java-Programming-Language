/*
 * Java program to demonstrate few functions of ArrayDequeue in Java
 */
import java.util.*;
...
public class ArrayDequeueDemo {
	...
	public static void main(String[] args) {
		...
		// descendingIterarator() : to reverse the dequeue order
		System.out.println("Elements of dequeue in reverse order: ");
		for(Iterator dItr = de_que.descendingIterator(); dItr.hasNext();)
		{
			System.out.println(dItr.next());
		}
		...
		System.out.println("\nHead Element using getFirst(): " + de_que.getFirst());
