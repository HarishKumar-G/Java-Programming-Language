/*
 * Java program to demonstrate use of Semaphore Locks
 */
	...
	public void run() {
		...
		if (this.getName().equals("A")) {
			...
			try
			{
				...
				// Now accessing the shared resource. Other waiting threads will wait, until thread
				// releases the lock
				for (int i = 0; i < 5; i++) {
					Shared.count++;
					System.out.println(threadName + ":" + Shared.count);
					
					// Now allowing a context switch -- if possible to thread B to execute
					Thread.sleep(10);
				}
